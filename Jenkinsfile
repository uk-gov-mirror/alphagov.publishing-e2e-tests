...
def apps = [
  [constantPrefix: "ASSET_MANAGER", app: "asset-manager", name: "Asset Manager", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "CALENDARS", app: "calendars", name: "Calendars", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "COLLECTIONS", app: "collections", name: "Collections", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "COLLECTIONS_PUBLISHER", app: "collections-publisher", name: "Collections Publisher", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "CONTACTS_ADMIN", app: "contacts-admin", name: "Contacts Admin", defaultCommitish: "rejig-foreman"],
  [constantPrefix: "CONTENT_STORE", app: "content-store", name: "Content Store", defaultCommitish: "rejig-foreman"],
  [constantPrefix: "CONTENT_TAGGER", app: "content-tagger", name: "Content Tagger", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "FINDER_FRONTEND", app: "finder-frontend", name: "Finder Frontend", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "FRONTEND", app: "frontend", name: "Frontend", defaultCommitish: "master"],
  [constantPrefix: "GOVERNMENT_FRONTEND", app: "government-frontend", name: "Government Frontend", defaultCommitish: "foreman-rejig"],
  [constantPrefix: "MANUALS_FRONTEND", app: "manuals-frontend", name: "Manuals Frontend", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "MANUALS_PUBLISHER", app: "manuals-publisher", name: "Manuals Publisher", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "PUBLISHER", app: "publisher", name: "Publisher", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "PUBLISHING_API", app: "publishing-api", name: "Publishing API", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "ROUTER", app: "router", name: "Router", defaultCommitish: "master"],
  [constantPrefix: "ROUTER_API", app: "router-api", name: "Router API", defaultCommitish: "unicorn"],
  [constantPrefix: "RUMMAGER", app: "rummager", name: "Rummager", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "SPECIALIST_PUBLISHER", app: "specialist-publisher", name: "Specialist Publisher", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "STATIC", app: "static", name: "Static", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "TRAVEL_ADVICE_PUBLISHER", app: "travel-advice-publisher", name: "Travel Advice Publisher", defaultCommitish: "foreman-dockerfile"],
  [constantPrefix: "WHITEHALL", app: "whitehall-admin", name: "Whitehall", defaultCommitish: "foreman-dockerfile"],
